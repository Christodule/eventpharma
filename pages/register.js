...
const register = () => {
	...
	return (
		<div>
			<Head>
				<title>Creer un compte | Cepharm Event</title>
				<meta
					name='description'
			...
			<main className='w-full flex items-center justify-between min-h-[100vh]'>
				<div className='md:w-[60%] w-full flex flex-col items-center justify-center min-h-[100vh] px-[30px] py-[30px] relative'>
					<Link href='/'>
						<h2 className='text-2xl font-medium mb-6'>Creer un compte</h2>
					</Link>
					<form
					...
					>
						...
						{password !== cpassword && (
							<p className='text-red-500 mb-2'>Mot de passe incorrect</p>
						)}
						<button
							type='submit'
					...
					<div className='absolute bottom-5 left-5'>
						<p className='opacity-50 text-sm'>
							<Link href='/'>Cepharm</Link> &copy; Copyright{" "}
